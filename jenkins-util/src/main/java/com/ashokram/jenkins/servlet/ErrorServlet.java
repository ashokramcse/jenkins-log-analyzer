...
public class ErrorServlet extends BaseHttpServlet {
    ...
    protected void doProcess(HttpServletRequest request, HttpServletResponse response)
        ...
        for (Map.Entry<String, Object> error : errorMap.entrySet()) {
            ...
            errorHTML.append("<tr><th scope=\"row\">" + ++sNo + "</th><td>" + error.getKey() + "</td><td>"
                    + errorstackTrace.toString() + "</td></tr>");
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(errorHTML.toString());
    }
}
