...
public class JenkinsManager {
    ...
    private Map<String, Job> getJobs(String url, String userName, String password)
    ...
    private void digTestAndFillMap(JobWithDetails details, String jobURL, String userName, String password)
            throws Exception {
        ...
        try {
            ...
            for (Object detailsOfModules : listOfPackages) {
                ...
                for (Object detailsOfClasses : listOfClasses) {
                    ...
                    jsonClient = client.get(url.concat("/").concat(String.valueOf(moduleDetails.get("name")))
                            .concat("/").concat(String.valueOf(classDetails.get("name"))));
                    resultMap = new Gson().fromJson(jsonClient, new TypeToken<HashMap<String, Object>>() {
                    }.getType());
                    ...
                    for (Object detailsOfTestCase : listOfTestCases) {
                        ...
                        jsonClient = client.get(url.concat("/").concat(String.valueOf(moduleDetails.get("name")))
                                .concat("/").concat(String.valueOf(classDetails.get("name")).concat("/")
                                        .concat(String.valueOf(testCase.get("name")))));
                        resultMap = new Gson().fromJson(jsonClient, new TypeToken<HashMap<String, Object>>() {
                        }.getType());
        ...
        if (JenkinsStaticStore.RESULT_MAP != null) {
            ...
            if (buildWithDetails.getResult() != null) {
                ...
                case FAILURE: {
                    ...
                    Map<String, Set<String>> failureTestCases = (Map<String, Set<String>>) JenkinsStaticStore.RESULT_MAP
                            .get(status);
                ...
                case UNSTABLE: {
                    ...
                    Map<String, Set<String>> unstableTestCases = (Map<String, Set<String>>) JenkinsStaticStore.RESULT_MAP
                            .get(status);
                ...
                case ABORTED: {
                    ...
                    Map<String, Set<String>> abortedTestCases = (Map<String, Set<String>>) JenkinsStaticStore.RESULT_MAP
                            .get(status);
    ...
    private void fillMapForTestJobs(Map<String, Object> resultMap) {
        if (JenkinsStaticStore.RESULT_MAP != null) {
            ...
            case "FAIL": {
                ...
                Set<String> faliureTestCasesList = (Set<String>) failureTestCases.get(failureReason);
                faliureTestCasesList
                        .add(getClassNameFromFullyQualifiedClassName(String.valueOf(resultMap.get("className")))
                                .concat(".").concat(String.valueOf(resultMap.get("name"))));
                log.info(getClassNameFromFullyQualifiedClassName(String.valueOf(resultMap.get("className"))).concat(".")
                        .concat(String.valueOf(resultMap.get("name"))));
                break;
            }
            case "FAILED": {
                status = BuildResult.FAILURE.name();
            ...
            case "PASS": {
                ...
                Set<String> testCaseName = (Set<String>) JenkinsStaticStore.RESULT_MAP.get(status);
                testCaseName.add(getClassNameFromFullyQualifiedClassName(String.valueOf(resultMap.get("className")))
                        .concat(".").concat(String.valueOf(resultMap.get("name"))));
                log.info(getClassNameFromFullyQualifiedClassName(String.valueOf(resultMap.get("className"))).concat(".")
                        .concat(String.valueOf(resultMap.get("name"))));
                break;
            ...
            default: {
                ...
                Set<String> otherTestCases = (Set<String>) JenkinsStaticStore.RESULT_MAP.get(status);
                otherTestCases.add(getClassNameFromFullyQualifiedClassName(String.valueOf(resultMap.get("className")))
                        .concat(".").concat(String.valueOf(resultMap.get("name"))));
                log.info(getClassNameFromFullyQualifiedClassName(String.valueOf(resultMap.get("className"))).concat(".")
                        .concat(String.valueOf(resultMap.get("name"))));
                break;
    ...
    private String getFailureReason(BuildWithDetails buildWithDetails) {
        ...
        try {
            failureStackTrace = IOUtils
                    .toString(buildWithDetails.getClient().getFile(new URI(buildWithDetails.getUrl() + "/console")));
        } catch (Exception e) {
        ...
        if (failureStackTrace == null) {
            ...
            try {
                if (JenkinsStaticStore.ERROR_STACK != null && JenkinsStaticStore.ERROR_STACK.size() > 0) {
                    ...
                    if (reason == null) {
                        return getFailureStack(
                                failureStackTrace.substring(failureStackTrace.indexOf(JenkinsConstants.FAILURE) + 8,
                                        failureStackTrace.indexOf(JenkinsConstants.ERROR)));
                    }
                } else {
                    return JenkinsConstants.DEFAULT_REASON;
                }
    ...
    private String getClassNameFromFullyQualifiedClassName(String classNameWithFullyQualifiedClassName) {
        ...
        return classNameWithFullyQualifiedClassName
                .substring(classNameWithFullyQualifiedClassName.lastIndexOf(".") + 1);
    }
}